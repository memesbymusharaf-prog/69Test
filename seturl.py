...
<a href='https://t.me/farxxes'>⊀</a> 𝐆𝚊𝐭𝐞𝐰𝚊𝐲 ↬ Site Validation
<a href='https://t.me/farxxes'>⊀</a> 𝐓𝐨𝐭𝚊𝐥 𝐒𝐢𝐭𝐞𝐬 ↬ <code>{total}</code>
<a href='https://t.me/farxxes'>⊀</a> 𝐓𝐞𝐬𝐭𝐞𝐝 ↬ <code>{tested}/{total} ({percentage}%)</code>
<a href='https://t.me/farxxes'>⊀</a> ✅ 𝐖𝐨𝐫𝐤𝐢𝐧𝐠 ↬ <code>{working}</code>
<a href='https://t.me/farxxes'>⊀</a> ❌ 𝐃𝐞𝐚𝐝 ↬ <code>{dead}</code>
...
<a href="https://t.me/farxxes">⊀</a> ✅ 𝐓𝐨𝐭𝚊𝐥 𝐖𝐨𝐫𝐤𝐢𝐧𝐠 ↬ <code>{len(working_sites)}/{len(sites_to_test)}</code>
<a href="https://t.me/farxxes">⊀</a> 💾 𝐀𝐝𝐝𝐞𝐝 𝐓𝐨 𝐃𝐁 (0-${max_price}) ↬ <code>{added_sites_count}</code>
<a href="https://t.me/farxxes">⊀</a> ❌ 𝐃𝐞𝐚𝐝 ↬ <code>{len(sites_to_test) - len(working_sites)}/{len(sites_to_test)}</code>
...
<a href="https://t.me/abtlnx">⌬</a> 𝐃𝐞𝐯 ↬ <a href="https://t.me/farxxes">kคli liຖนxx</a>"""
...
<a href='https://t.me/farxxes'>⌬</a> 𝐃𝐞𝐯 ↬ <a href='https://t.me/failedfr'>kคli liຖนxx</a>"""
        else:
            message = f"""<pre>⩙ 𝑺𝒕𝒂𝒕𝒖𝒔 ↬ 𝙉𝙤 𝙎𝙞𝙩𝙚𝙨 ⚠️</pre>
<a href='https://t.me/farxxes'>⊀</a> 𝐌𝐞𝐬𝐬𝐚𝐠𝐞 ↬ <i>You don't have any sites configured.</i>
...
<a href='https://t.me/farxxes'>⊀</a> 𝐓𝐨𝐭𝚊𝐥 𝐒𝐢𝐭𝐞𝐬 ↬ <code>{len(sites_to_test)}</code>
...
<a href='https://t.me/farxxes'>⊀</a> 𝐌𝐞𝐬𝐬𝐚𝐠𝐞 ↬ <i>Site removed successfully!</i>

<a href='https://t.me/farxxes'>⊀</a> 𝐑𝐞𝐦𝚊𝐢𝐧𝐢𝐧𝐠 ↬ <code>{len(user_sites)} sites</code>
<a href='https://t.me/farxxes'>⌬</a> 𝐃𝐞𝐯 ↬ <a href='https://t.me/farxxes'>kคli liຖนxx</a>"""
        else:
            message = f"""<pre>⩙ 𝑺𝒕𝒂𝒕𝒖𝒔 ↬ 𝙎𝙪𝘾𝙘𝙚𝙨𝙨 ✅</pre>
<a href='https://t.me/farxxes'>⊀</a> 𝐌𝐞𝐬𝐬𝐚𝐠𝐞 ↬ <i>Site removed successfully!</i>
...
<a href='https://t.me/farxxes'>⌬</a> 𝐃𝐞𝐯 ↬ <a href='https://t.me/farxxes'>kคli liຖนxx</a>"""
        ...
        await update.message.reply_text(
            f"""<pre>⩙ 𝑺𝒕𝒂𝒕𝒖𝒔 ↬ 𝙀𝙧𝙧𝙤𝙧 ⚠️</pre>
<a href='https://t.me/farxxes'>⊀</a> 𝐌𝐞𝐬𝐬𝐚𝐠𝐞 ↬ <i>Failed to remove site!</i>
...
<a href='https://t.me/farxxes'>⊀</a> ✅ 𝐖𝐨𝐫𝐤𝐢𝐧𝐠 ↬ <code>{len(working_sites)}/{len(user_sites)}</code>
<a href='https://t.me/farxxes'>⊀</a> ❌ 𝐃𝐞𝐚𝐝 𝐑𝐞𝐦𝐨𝐯𝐞𝐝 ↬ <code>{len(user_sites) - len(working_sites)}/{len(user_sites)}</code>
...
<a href='https://t.me/abtlnx'>⌬</a> 𝐃𝐞𝐯 ↬ <a href='https://t.me/farxxes'>kคli liຖนxx</a>""",
    ...
    progress_msg = f"""<pre>⩙ 𝑺𝒕𝒂𝒕𝒖𝒔 ↬ 𝙋𝙧𝙤𝙘𝙚𝙨𝙨𝙞𝙣𝙜 📊</pre>
<a href='https://t.me/farxxes'>⊀</a> 𝐆𝚊𝐭𝐞𝐰𝚊𝐲 ↬ Site Revalidation
<a href='https://t.me/farxxes'>⊀</a> 𝐓𝐨𝐭𝚊𝐥 𝐒𝐢𝐭𝐞𝐬 ↬ <code>{len(user_sites)}</code>
<a href='https://t.me/farxxes'>⊀</a> 𝐓𝐞𝐬𝐭𝐞𝐝 ↬ <code>0/{len(user_sites)} (0%)</code>
<a href='https://t.me/farxxes'>⊀</a> ✅ 𝐖𝐨𝐫𝐤𝐢𝐧𝐠 ↬ <code>0</code>
<a href='https://t.me/farxxes'>⊀</a> ❌ 𝐃𝐞𝐚𝐝 ↬ <code>0</code>
<a href='https://t.me/farxxes'>⌬</a> 𝐃𝐞𝐯 ↬ <a href='https://t.me/farxxes'>kคli liຖนxx</a>"""
