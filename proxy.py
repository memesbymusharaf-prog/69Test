...
async def process_proxy_test(proxies: List[str], user_id: int, first_name: str, processing_message, context):
    ...
    try:
        ...
        message_text += (
            f"<a href='https://t.me/farxxes'>&#x2140;</a> <b>𝐅𝐚𝐢𝐥𝐞𝐝</b> ↬ <code>{len(failed_proxies)} proxies</code>\n"
        )
        ...
        message_text += (
            f"<a href='https://t.me/farxxes'>&#x232c;</a> <b>𝐔𝐬𝐞𝐫</b> ↬ <a href='tg://user?id={user_id}'>{first_name}</a>\n"
            f"<a href='https://t.me/farxxes'>&#x232c;</a> <b>𝐃𝐞𝐯</b> ↬ <a href='https://t.me/farxxes'>kคli liຖนxx</a>"
        )
        ...
        error_message = (
            f"<pre><a href='https://t.me/farxxes'>&#x2a9d;</a> <b>𝑺𝒕𝒂𝒕𝒖𝒔</b> ↬ <b>𝙀𝙧𝙧𝙤𝙧</b> &#x274c;</pre>\n"
            f"<a href='https://t.me/farxxes'>&#x2140;</a> <b>𝐑𝐞𝐬𝐩𝐨𝐧𝐬𝐞</b> ↬ <code>An error occurred while testing proxies: {str(e)}</code>\n"
            f"<a href='https://t.me/farxxes'>&#x232c;</a> <b>𝐔𝐬𝐞𝐫</b> ↬ <a href='tg://user?id={user_id}'>{first_name}</a>\n"
            f"<a href='https://t.me/farxxes'>&#x232c;</a> <b>𝐃𝐞𝐯</b> ↬ <a href='https://t.me/farxxes'>kคli liຖนxx</a>"
        )
...
async def handle_rproxy_command(update, context):
    ...
    if success:
        if count == -1:
            message_text = (
                f"<pre><a href='https://t.me/farxxes'>&#x2a9d;</a> <b>𝑺𝒕𝒂𝒕𝒖𝒔</b> ↬ <b>𝙎𝙪𝙘𝙘𝙚𝙨𝙨</b> &#x2705;</pre>\n"
                f"<a href='https://t.me/farxxes'>&#x2140;</a> <b>𝐑𝐞𝐦𝐨𝐯𝐞𝐝</b> ↬ <code>All proxies</code>\n"
                f"<a href='https://t.me/farxxes'>&#x2140;</a> <b>𝐑𝐞𝐬𝐩𝐨𝐧𝐬𝐞</b> ↬ <code>{message}</code>\n"
                f"<a href='https://t.me/farxxes'>&#x232c;</a> <b>𝐔𝐬𝐞𝐫</b> ↬ <a href='tg://user?id={user_id}'>{first_name}</a>\n"
                f"<a href='https://t.me/farxxes'>&#x232c;</a> <b>𝐃𝐞𝐯</b> ↬ <a href='https://t.me/farxxes'>kคli liຖนxx</a>"
            )
        else:
            message_text = (
                f"<pre><a href='https://t.me/farxxes'>&#x2a9d;</a> <b>𝑺𝒕𝒂𝒕𝒖𝒔</b> ↬ <b>𝙎𝙪𝙘𝙘𝙚𝙨𝙨</b> &#x2705;</pre>\n"
                f"<a href='https://t.me/farxxes'>&#x2140;</a> <b>𝐑𝐞𝐦𝐨𝐯𝐞𝐝</b> ↬ <code>{count} proxies</code>\n"
                f"<a href='https://t.me/farxxes'>&#x2140;</a> <b>𝐑𝐞𝐬𝐩𝐨𝐧𝐬𝐞</b> ↬ <code>{message}</code>\n"
                f"<a href='https://t.me/farxxes'>&#x232c;</a> <b>𝐔𝐬𝐞𝐫</b> ↬ <a href='tg://user?id={user_id}'>{first_name}</a>\n"
                f"<a href='https://t.me/farxxes'>&#x232c;</a> <b>𝐃𝐞𝐯</b> ↬ <a href='https://t.me/farxxes'>kคli liຖนxx</a>"
            )
        ...
        message_text = (
            f"<pre><a href='https://t.me/farxxes'>&#x2a9d;</a> <b>𝑺𝒕𝒂𝒕𝒖𝒔</b> ↬ <b>𝙀𝙧𝙧𝙤𝙧</b> &#x274c;</pre>\n"
            f"<a href='https://t.me/farxxes'>&#x2140;</a> <b>𝐑𝐞𝐦𝐨𝐯𝐞𝐝</b> ↬ <code>{count if count != -1 else 'All'} proxies</code>\n"
            f"<a href='https://t.me/farxxes'>&#x2140;</a> <b>𝐑𝐞𝐬𝐩𝐨𝐧𝐬𝐞</b> ↬ <code>{message}</code>\n"
            f"<a href='https://t.me/farxxes'>&#x232c;</a> <b>𝐔𝐬𝐞𝐫</b> ↬ <a href='tg://user?id={user_id}'>{first_name}</a>\n"
            f"<a href='https://t.me/farxxes'>&#x232c;</a> <b>𝐃𝐞𝐯</b> ↬ <a href='https://t.me/farxxes'>kคli liຖนxx</a>"
        )
...
async def handle_myproxy_command(update, context):
    ...
    if not proxies:
        message_text = (
            f"<pre><a href='https://t.me/farxxes'>&#x2a9d;</a> <b>𝑺𝒕𝒂𝒕𝒖𝒔</b> ↬ <b>𝙄𝙣𝙛𝙤</b> &#x2139;&#xfe0f;</pre>\n"
            f"<a href='https://t.me/farxxes'>&#x2140;</a> <b>𝐏𝐫𝐨𝐱𝐢𝐞𝐬</b> ↬ <code>0/10</code>\n"
            f"<a href='https://t.me/farxxes'>&#x2140;</a> <b>𝐑𝐞𝐬𝐩𝐨𝐧𝐬𝐞</b> ↬ <code>You don't have any proxies. Use /proxy username:password@host:port to add a proxy.</code>\n"
            f"<a href='https://t.me/farxxes'>&#x232c;</a> <b>𝐔𝐬𝐞𝐫</b> ↬ <a href='tg://user?id={user_id}'>{first_name}</a>\n"
            f"<a href='https://t.me/farxxes'>&#x232c;</a> <b>𝐃𝐞𝐯</b> ↬ <a href='https://t.me/farxxes'>kคli liຖนxx</a>"
        )
    ...
    # Create a properly formatted message
    message_text = (
        f"<pre><a href='https://t.me/farxxes'>&#x2a9d;</a> <b>𝑺𝒕𝒂𝒕𝒖𝒔</b> ↬ <b>𝙇𝙞𝙨𝙩</b> &#x1f4cb;</pre>\n"
        f"<a href='https://t.me/farxxes'>&#x2140;</a> <b>𝐏𝐫𝐨𝐱𝐢𝐞𝐬</b> ↬ <code>{len(proxies)}/10</code>\n"
        f"<a href='https://t.me/farxxes'>&#x2140;</a> <b>𝐑𝐞𝐬𝐩𝐨𝐧𝐬𝐞</b> ↬ <pre>{proxy_list}</pre>\n"
        f"<a href='https://t.me/farxxes'>&#x232c;</a> <b>𝐔𝐬𝐞𝐫</b> ↬ <a href='tg://user?id={user_id}'>{first_name}</a>\n"
        f"<a href='https://t.me/farxxes'>&#x232c;</a> <b>𝐃𝐞𝐯</b> ↬ <a href='https://t.me/farxxes'>kคli liຖนxx</a>"
    )
